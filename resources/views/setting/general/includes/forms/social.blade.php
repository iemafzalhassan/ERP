<div class="form-group">
    <label class="col-sm-2 control-label">
        <i class="fa fa-facebook bigger-120 white" aria-hidden="true"></i> Facebook
    </label>
    <div class="col-sm-4">
    ...
    <label class="col-sm-2 control-label">
        <i class="fa fa-twitter bigger-120 white" aria-hidden="true"></i> Twitter
    </label>
    <div class="col-sm-4">
...
<div class="form-group">
    <label class="col-sm-2 control-label">
        <i class="fa fa-linkedin bigger-120 white" aria-hidden="true"></i> LinkedIn
    </label>
    <div class="col-sm-4">
    ...
    <label class="col-sm-2 control-label">
        <i class="fa fa-youtube bigger-120 white" aria-hidden="true"></i> Youtube
    </label>
    <div class="col-sm-4">
...
<div class="form-group">
    <label class="col-sm-2 control-label">
        <i class="fa fa-google-plus bigger-120 white" aria-hidden="true"></i> Google+
    </label>
    <div class="col-sm-4">
    ...
    <label class="col-sm-2 control-label">
        <i class="fa fa-instagram bigger-120 white" aria-hidden="true"></i>InstaG.
    </label>
    <div class="col-sm-4">
...
<div class="form-group">
    <label class="col-sm-2 control-label">
        <i class="fa fa-whatsapp bigger-120 white" aria-hidden="true"></i> WhatsApp
    </label>
    <div class="col-sm-4">
    ...
    <label class="col-sm-2 control-label">
        <i class="fa fa-skype bigger-120 white" aria-hidden="true"></i> Skype
    </label>
    <div class="col-sm-4">
...
<div class="form-group">
    <label class="col-sm-2 control-label">
        <i class="fa fa-pinterest bigger-120 white" aria-hidden="true"></i> Pinterest
    </label>
    <div class="col-sm-4">
    ...
    <label class="col-sm-2 control-label">
        <i class="fa fa-wordpress bigger-120 white" aria-hidden="true"></i> WordPr.
    </label>
    <div class="col-sm-4">
