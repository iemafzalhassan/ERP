            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <!-- PAGE CONTENT BEGINS -->
                        ...
                        <a class="{!! request()->is('product/import*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('product.import') }}"><i class="fa fa-upload" aria-hidden="true"></i>&nbsp;Bulk Customer Registration</a>
                        </div>
